...
*/}}
{{- define "kerberus-dashboard.name" -}}
...
*/}}
{{- define "kerberus-dashboard.fullname" -}}
...
app.kubernetes.io/name: {{ include "kerberus-dashboard.name" . }}-app
...
*/}}
{{- define "kerberus-dashboard.backend.labels" -}}
app.kubernetes.io/name: {{ include "kerberus-dashboard.name" . }}-backend
helm.sh/chart: {{ include "kerberus-dashboard.chart" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
...
*/}}
{{- define "kerberus-dashboard.postgresql.fullname" -}}
...
*/}}
{{- define "kerberus-dashboard.app.serviceAccountName" -}}
...
*/}}
{{- define "kerberus-dashboard.backend.serviceAccountName" -}}
...
*/}}
{{- define "kerberus-dashboard.backend.postgresCaFilename" -}}
{{ include "kerberus-dashboard.backend.postgresCaDir" . }}/{{- required "The name for the CA certificate file for postgresql is required" .Values.global.postgresql.caFilename }}
{{- end -}}
{{/*
...
*/}}
{{- define "kerberus-dashboard.backend.postgresCaDir" -}}
...
*/}}
{{- define "kerberus-dashboard.lighthouse.postgresCaFilename" -}}
{{ include "kerberus-dashboard.lighthouse.postgresCaDir" . }}/{{- required "The name for the CA certificate file for postgresql is required" .Values.global.postgresql.caFilename }}
{{- end -}}

{{/*
Directory path to the CA certificate file in lighthouse
*/}}
{{- define "kerberus-dashboard.lighthouse.postgresCaDir" -}}
...
*/}}
{{- define "kerberus-dashboard.postgresql.generateCA" -}}
{{- $ca := .ca | default (genCA (include "kerberus-dashboard.postgresql.fullname" .) 365) -}}
{{- $_ := set . "ca" $ca -}}
{{- $ca.Cert -}}
{{- end -}}
...
{{- $postgresName := (include "kerberus-dashboard.postgresql.fullname" .) }}
...
{{ include "kerberus-dashboard.fullname" . }}-backend
{{- end -}}
...
{{ include "kerberus-dashboard.fullname" . }}-frontend
{{- end -}}
...
{{ include "kerberus-dashboard.fullname" . }}-lighthouse
{{- end -}}
...
{{- include "kerberus-dashboard.postgresql.fullname" . }}
{{- end -}}
...
{{- if .Values.postgresql.enabled }}
{{- template "kerberus-dashboard.postgresql.fullname" . }}
{{- else -}}
{{ $secretName := (printf "%s-backend-postgres" (include "kerberus-dashboard.fullname" . )) }}
...
{{- template "kerberus-dashboard.postgresql.fullname" . }}
{{- else -}}
{{ $secretName := (printf "%s-lighthouse-postgres" (include "kerberus-dashboard.fullname" . )) }}
...
*/}}
{{- define "kerberus-dashboard.appConfigFilename" -}}
{{- "app-config.yaml" -}}
{{- end -}}
