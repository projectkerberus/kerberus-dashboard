...
- 73f3f5d78: Updates the end to end test in the app to match the new catalog index page title. To apply this change to an existing app, update `packages/app/cypress/integration/app.js` to search for `"Kerberus Dashboard"` instead of `"Kerberus Dashboard Service Catalog"`.
